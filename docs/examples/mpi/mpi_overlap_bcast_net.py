...
if rank == root:
    ...
    print("Converting circuits to nets.")  # noqa: T201
    sys.stdout.flush()
    time0 = MPI.Wtime()
...
if rank == root:
    ...
    print("Broadcasting the net of the circuits.")  # noqa: T201
    sys.stdout.flush()
...
time1 = MPI.Wtime()
print(f"Nets broadcasted to {rank} in {time1-time0} seconds")  # noqa: T201
